...
namespace Microsoft.Azure.Devices.Edge.Agent.Docker
{
    ...
    {
        [JsonConstructor]
        public EdgeAgentDockerModule(string type, DockerConfig settings, ConfigurationInfo configuration, IDictionary<string, EnvVal> env, IDictionary<string, AdvertisedServiceProfile> services, string version = "")
            : base(Core.Constants.EdgeAgentModuleName, version, ModuleStatus.Running, RestartPolicy.Always, settings, configuration, env, services)
        {
