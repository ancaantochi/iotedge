...
namespace Microsoft.Azure.Devices.Registration.Clients.Devices.V20190115
{
    internal class SymmetricKeyCredentials : ServiceClientCredentials
    {
        ...
        public override Task ProcessHttpRequestAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            this._sasToken = ProvisioningSasBuilder.BuildSasSignature(Registration, this.SymmetricKey, string.Concat(segments[0], '/', segments[1], '/', segments[2]), TimeSpan.FromDays(1));
            SetAuthorizationHeader(request, this._sasToken);
